...
-- Eseguire su Supabase SQL Editor, poi ricaricare /admin/parametri → tab Servizi.
...
-- Seed iniziale (solo se tabella vuota)
...
-- RLS (solo se esiste is_admin(); altrimenti la tabella resta usabile)
do $$
begin
  if exists (
    select 1
